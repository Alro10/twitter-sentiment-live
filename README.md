...
<p align="center">
<img src="https://github.com/Alro10/twitter-sentiment-live/blob/master/dash.png" alt="alt text" width="100%" height="100%">
</p>
...
- `twitter_stream.py` - This should run in the background of your application. This is what streams tweets from Twitter, storing them into the sqlite3 database.
