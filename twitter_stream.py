...
ckey='46pvnSwIVylfWepbPsP4433wL'
csecret='xWDPHaUkk0ub93qj1DaYgJcO8QtkPUhNFIE7uBAvzbSVLLpLzR'
atoken='1952916806-9WbU9ROPLd4aVPprQZqWJhaW4RSXrBw4oK8A4Ow'
asecret='gW5iuYPtrTxVhPmQxBemsKz6jCAOqbYx1fT0ewKHFyAkG'
...
while True:
    ...
    try:
        ...
        #twitterStream.filter(languages=["pt"], track = ["a","e","i","o","u"])
        twitterStream.filter(languages=["pt"],track=["a","e","i","o","u"])
